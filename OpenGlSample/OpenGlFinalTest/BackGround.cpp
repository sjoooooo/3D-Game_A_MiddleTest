...
{
	FileManager::instance()->loadOBJs(this, "cube.obj", "skyblue.bmp", "20161614_vs.shader", "20161614_fs.shader");
...
void Background::setRot(float speed, float x, float y, float z)
{
	rotSpeed = speed;
